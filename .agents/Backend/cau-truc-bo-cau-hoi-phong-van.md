...
Tài liệu chỉ bổ sung thêm cấu trúc cho các câu hỏi phỏng vấn, vẫn giữ nguyên input là dữ liệu của CV, JD, bộ câu hỏi mẫu để model sinh câu hỏi một cách chính xác.
...
## Định dạng Output mong muốn (gợi ý cho model/agent)

Khi sinh bộ câu hỏi, model/agent nên trả về theo cấu trúc:
...
## Quy tắc ràng buộc cho Model / Agent
...
8. Phần mở đầu buổi phỏng vấn hầu như sẽ là lời mở đầu chào "tên ứng viên" ứng tuyển vào vị trí (được ghi trong jd) rồi nối tiếp vào phần 1 mời ứng viên giới thiệu bản thân.
