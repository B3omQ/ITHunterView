...
namespace ITHunterview.Service.UseCase
{
    public class UserGovernanceUseCase : IUserGovernanceUseCase
    {
        ...
        public UserGovernanceUseCase(IUserRepository userRepository, ITokenRepository tokenRepository, IMemoryCache cache, IAuditLogRepository auditLogRepository)
        {
