...
export const APP_ROUTES = {
  ...
  CANDIDATE: {
    ...
    CV_MATCHING: '/candidate/cv-matching',
    OPTIMIZE_CV: '/candidate/optimize-cv',
    LEARNING_PATH: '/candidate/learning-path',
    INTERVIEW: '/candidate/interview',
    APPLICATIONS: '/candidate/applications',
    PRICING: '/candidate/pricing',
    TOP_UP: '/candidate/top-up',
    BILLING_HISTORY: '/candidate/billing-history',
  ...
  RECRUITER: {
    ...
    TOP_UP: '/recruiter/top-up',
    BILLING_HISTORY: '/recruiter/billing-history',
...
export const ROLE_MENUS: Record<string, Array<{ label: string; href: string; icon: string }>> = {
  candidate: [
    ...
    { label: 'CV-JD Matching', href: APP_ROUTES.CANDIDATE.CV_MATCHING, icon: 'History' },
    { label: 'Optimize CV', href: APP_ROUTES.CANDIDATE.OPTIMIZE_CV, icon: 'Sparkles' },
