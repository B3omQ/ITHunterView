    ...
    <div className="min-h-screen bg-background transition-colors duration-200">
      <div className="w-full pb-8 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-2">
          <div>
            <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-zinc-50 tracking-tight">Question Bank (Admin)</h1>
            <p className="text-zinc-500 dark:text-zinc-400 mt-1.5 text-sm">Manage sample interview questions across all domains</p>
          </div>
          <Button
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 py-2 border-b border-zinc-200 dark:border-zinc-800 mb-4">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="h-10 w-full sm:w-44 rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-zinc-950 dark:text-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            >
