  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-200">
      <div className="w-full pb-10 space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-2">
          <div>
            ...
            <p className="text-[#65676B] dark:text-zinc-400 mt-1.5 text-sm">
              Manage sample interview questions and assessment criteria.
            </p>
          </div>
        ...
        {/* TẦNG 1: TOOLBAR (Search, Industry, Level Filters, Reset, Refresh) */}
          ...
          <div className="flex flex-wrap items-center gap-2.5 flex-1">
            ...
            <div className="relative w-full sm:w-72 md:w-80">
              ...
              <Input
                ...
                placeholder="Search question text, industry..."
          ...
          <Table className="w-full text-left border-collapse table-fixed">
            ...
            <TableHeader className="bg-slate-50 dark:bg-zinc-950 border-b border-[#CED0D4] dark:border-zinc-800">
              <TableRow className="hover:bg-transparent border-none">
                ...
                <TableHead className="w-[63%] py-3 px-3 text-xs font-semibold uppercase tracking-wider text-[#65676B] dark:text-zinc-400">
                  QUESTION & ANSWER
                </TableHead>
              ...
              {loading ? (
                  ...
                  <TableRow key={index} className="border-b border-[#CED0D4]/60 dark:border-zinc-800/60">
                    <TableCell className="py-3.5 px-3">
                      <div className="space-y-1">
                        ...
                        <Skeleton className="h-5 w-16 bg-slate-100 dark:bg-zinc-800 rounded-full" />
                      </div>
                    </TableCell>
                    <TableCell className="py-3.5 px-3">
                  ...
                  <TableCell colSpan={3} className="h-72 text-center">
                    <div className="flex flex-col items-center justify-center max-w-sm mx-auto text-center">
                      ...
                      <p className="text-sm text-[#65676B] dark:text-zinc-400 mt-1 mb-4">
                        {isFilterActive
                          ? 'No questions match the current filters. Try clearing or adjusting your search criteria.'
                          : 'No interview questions available in the question bank.'}
                      </p>
                      {isFilterActive && (
                        <Button
                          onClick={handleResetFilters}
                ...
                filteredQuestions.map((q) => (
                  ...
                  >
                    ...
                    <TableCell className="py-3.5 px-3 align-top">
                      <p className="font-medium text-sm text-[#050505] dark:text-zinc-100 whitespace-pre-wrap leading-relaxed">
                        {q.questionText}
                      </p>
                    </TableCell>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-1 px-1">
          <div className="flex items-center space-x-3 text-sm text-[#65676B] dark:text-zinc-400">
            <div>
              Showing <span className="font-semibold text-[#050505] dark:text-zinc-200">{startResult} - {endResult}</span> of <span className="font-semibold text-[#050505] dark:text-zinc-200">{totalCount}</span> questions
            </div>
            <Select
