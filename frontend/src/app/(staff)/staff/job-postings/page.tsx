  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-200">
      <div className="w-full pb-10 space-y-5">
        ...
        {/* TẦNG 1: TOOLBAR (Search, Status Filter, Reset, Refresh) */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <Button
              variant="outline"
              onClick={() => fetchJobs(page, pageSize, debouncedSearch || undefined, statusFilter === 'ALL' ? undefined : statusFilter)}
              disabled={loading}
                  ...
                  >
                    ...
                    <TableCell className="py-3.5 px-3 align-middle">
                      <span
                        ...
                        className="font-bold text-sm text-[#050505] dark:text-zinc-100 group-hover:text-[#1877F2] dark:group-hover:text-blue-400 transition-colors line-clamp-1 cursor-pointer"
                        title={job.title}
                      >
                        {job.title}
                      </span>
        ...
        <DialogContent>
          ...
          <div className="py-4">
            <Input
              ...
              autoFocus
              className="border-[#CED0D4] dark:border-zinc-800 focus-visible:ring-[#1877F2]"
            />
          </div>
          <DialogFooter>
