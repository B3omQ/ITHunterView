...
import { FileText, Bell, TrendingUp, Star } from "lucide-react"
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={app.company} className="flex items-center gap-3 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
                <div className="w-9 h-9 rounded-lg flex-shrink-0 flex items-center justify-center bg-muted font-semibold text-sm">
