...
import { ArrowLeft, Loader2, FileText, Briefcase, Eye } from 'lucide-react';
...
export default function CvMatchingHistoryPage() {
  ...
  const navigateToDetail = (jobId: string) => {
    router.push(`${APP_ROUTES.CANDIDATE.CV_MATCHING}?jobId=${jobId}`);
  };
    ...
    <div className="max-w-6xl mx-auto w-full py-8 px-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" onClick={() => router.push(APP_ROUTES.CANDIDATE.CV_MATCHING)}>
